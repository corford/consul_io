...
#
# (c) 2017, Charlie Orford
#
# Improved version based on the original by Steve Gargan
...
--domain, appended to hosts and resolvable by Consul internal DNS
...
ANSIBLE_INVENTORY_CONSUL_DOMAIN
...
class ConsulConfig(dict):
    ...
    def read_env_vars(self):
        ...
        var_names = {
            ...
            'ANSIBLE_INVENTORY_CONSUL_DOMAIN': 'domain'
        }
    ...
    def read_cli_args(self):
        ...
        parser = argparse.ArgumentParser(description=
            'Produce an Ansible Inventory file based on nodes in a Consul cluster')
        ...
        parser.add_argument('--domain', action='store',
            help='Domain name to append to inventory hosts (will be resolvable \
                by Consul internal DNS')

        args = parser.parse_args()
        arg_names = ['host', 'datacenter', 'url', 'domain']
